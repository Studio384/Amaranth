...
export const aiArrowUpRightFromSquare: {
  ...
  name: 'arrow_up_right_from_square',
  data: `<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="ai" viewBox="0 0 16 16"><path d="M11.25 0a.75.75 0 0 0 0 1.5h2.19L8.72 6.22a.75.75 0 0 0 1.06 1.06l4.72-4.72v2.19a.75.75 0 0 0 1.5 0v-4a.75.75 0 0 0-.75-.75z"/><path d="M2.75 1A2.75 2.75 0 0 0 0 3.75v9.5A2.75 2.75 0 0 0 2.75 16h9.5A2.75 2.75 0 0 0 15 13.25v-5.5a.75.75 0 0 0-1.5 0v5.5c0 .69-.56 1.25-1.25 1.25h-9.5c-.69 0-1.25-.56-1.25-1.25v-9.5c0-.69.56-1.25 1.25-1.25h5.5a.75.75 0 0 0 0-1.5z"/></svg>`
};
