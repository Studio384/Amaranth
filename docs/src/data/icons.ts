...
const icons = [
  ...
  {
    component: 'aiRocket',
    categories: ["transportation","science"],
    tags: ["launch"],
    slug: 'rocket',
    icon: aiRocket
  },
